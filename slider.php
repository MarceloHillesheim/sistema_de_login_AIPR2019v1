            ...
            <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="imagens/rodrigocaio.jpg" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Rodrigo Caio</h5>
                            <p>Zagueiro do Flamengo em um jogo <br> contra o Corinthians.</p>
                        </div>
                    </div>
                    <div class="carousel-item">
                        <img src="imagens/bruno.jpg" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Bruno Henrique</h5>
                            <p>Atacante do Flamengo fazendo sua estreia <br> na Seleção Brasileira.</p>
                        </div>
                    </div>
                    <div class="carousel-item">
