...
<html lang="pt-br">
    <head>
        ...
        <title>Sistema de Login MX Systems</title>
    </head>
<body class="bg-dark">
        ...
        <section class="row mb-5">
            <div class="col-lg-4 offset-lg-4 bg-light rounded" id="caixaCadastro">
                ...
                <form action="#" class="p-2" id="frmCadastro">
                    ...
                    <div class="form-group">
                        <input type="text" name="nomeUsuário" id="nomrUsuário" class="form-control"
                    ...
                    <div class="form-group">
                        <input type="submit" value=":: Cadastrar ::" class="btn btn-primary brn-block"
                        id="btnRegistrar">
                    </div>
